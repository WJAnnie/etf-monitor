...
class Blocker(StrEnum):
    FUNDAMENTAL_VETO="FUNDAMENTAL_VETO"; NO_CHAN_BUY="NO_CHAN_BUY"; DAILY_FIRST_BUY_WAIT_2B="DAILY_FIRST_BUY_WAIT_2B"; SIGNAL_NOT_MATURE="SIGNAL_NOT_MATURE"; STOP_UNDEFINED="STOP_UNDEFINED"; RISK_TOO_HIGH="RISK_TOO_HIGH"; TECHNICAL_EXECUTION_PAUSED="TECHNICAL_EXECUTION_PAUSED"; PARENT_CONTEXT_INVALID="PARENT_CONTEXT_INVALID"; DATA_INCOMPLETE="DATA_INCOMPLETE"; PORTFOLIO_RISK_FULL="PORTFOLIO_RISK_FULL"; NO_NEW_STRUCTURE_FOR_ADD="NO_NEW_STRUCTURE_FOR_ADD"; REENTRY_LOCKED="REENTRY_LOCKED"
