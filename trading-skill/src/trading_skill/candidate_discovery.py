...
CASH_TOKENS = (
    "货币", "同业存单", "日利", "添益", "保证金", "现金管理", "招商快线", "快钱ETF",
)
COMMODITY_TOKENS = (
...
SECTOR_TOKENS = (
    "白酒", "酒ETF", "食品", "消费", "医药", "医疗", "创新药", "证券", "券商", "银行", "保险", "金融", "地产",
    "科技", "互联网", "软件", "通信", "半导体", "芯片", "电子", "军工", "国防", "航天", "通用航空", "新能源", "光伏",
    "电池", "汽车", "机械", "农业", "农牧渔", "养殖", "粮食", "煤炭", "有色", "钢铁", "矿业", "资源", "石化", "化工", "能源", "绿电", "电力", "公用事业",
    "交通运输", "运输ETF", "物流", "旅游", "基建", "一带一路", "船舶", "教育", "传媒", "游戏", "人工智能", "机器人", "黄金股",
)
